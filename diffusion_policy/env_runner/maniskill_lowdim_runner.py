...
class ManiSkillLowdimRunner(BaseLowdimRunner):
    """
    Runner per ambienti ManiSkill in modalità lowdim,
    adattato da RobomimicLowdimRunner.
    Compatibile con Gymnasium>=0.29 e con ManiSkill3.
    """
    ...
    def __init__(
        ...
        # gestisce la latenza: aggiunge osservazioni extra per simulare ritardo
        ...
        # ----------------------------------------------------------------------
        # Funzione per creare un singolo ambiente
        # ----------------------------------------------------------------------
        def env_fn():
    ...
    def run(self, policy: BaseLowdimPolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(
                ...
                desc=f"Eval {self.env_id} Lowdim {chunk_idx+1}/{n_chunks}",
                leave=False,
    ...
    def undo_transform_action(self, action):
        """Converte le azioni normalizzate in formato ManiSkill"""
